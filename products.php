...
.item {
    ...
    flex-basis: 200;
        ...
        <div class="product">
            ...
            <input class="prodsearch" id="search" type="search" name="searchprod"class="fa fa-search"  oninput="w3.filterHTML('#id02', '.ite', this.value)" placeholder='Search for articles/books/categories...'/>
            </p>
        <div class="row">
