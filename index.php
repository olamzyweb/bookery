...
<html>
  ...
  <a class="carousel-control-next" href="#demo" data-slide="next">
    <span class="carousel-control-next-icon"></span>
        ...
        <div class="jumbotron">
        <div>
        <img src="images/img10.jpg" alt="abtimg" style="float:left; padding-top: 30px; padding-bottom: 30px; padding-right: 30px; border-radius: 20%;
...
<div class="slideshow-container">
  ...
  <div class="mySlides">
    <q>I've just found the best book that works well.</q>
...
<div id="result"></div>
<button type="submit" name="submit" id="submit" style="background-image: linear-gradient(to bottom right, #69bb8a,#4dad85,#3c7d5c);; color: white;border: 0px; border-radius: 20px; height: 50px; font-size: 20px;">Send Message</button>
</div>
    </form>
  </div>
